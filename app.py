...
lineaccesstoken = '9XKGsCUvolC2CiArz5+bARILEzWqgvynLHaBbhqNvLURunQEbDj67Pg+t6lR6rJTdMmd+vcn/9MGCpaejN0H91v274RdHpScgF56NM1ESq6na1y/lBguy0stl47oMc2FC9sKqWimaXjufsjYBZvaaAdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            ...
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "อยากกินเปาะเปี๊ยะ") :
            replyObj = TextSendMessage(text="ซื้อ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "ไปเที่ยวกัน") :
            replyObj = TextSendMessage(text="ขี้เกียจ")
            line_bot_api.reply_message(rtoken, replyObj)
            elif msg == "covid" :
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/8893724c-5c93-478d-87d1-b59a76ca2271"
